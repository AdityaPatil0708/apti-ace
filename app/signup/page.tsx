    ...
    <div className="min-h-screen w-screen flex bg-white">
      ...
      <div className="w-full lg:w-[60%] flex flex-col justify-center items-center px-8 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-gray-400 text-sm mb-8">Start practicing for free today</p>

          {/* Google Button */}
          <button
            type="button"
            className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 mb-6"
          >
